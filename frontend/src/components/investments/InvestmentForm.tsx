...
const InvestmentForm: FC<InvestmentFormProps> = ({ onClose, onSubmit, initialData }) => {
  ...
  const inputClass = `w-full px-3 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 ${
    isDark
      ? 'bg-gray-700 border-gray-600 text-gray-100 placeholder-gray-400'
      : 'border-gray-300 text-gray-900'
  }`;
  const inputWithPrefixClass = `w-full px-8 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 ${
    isDark
      ? 'bg-gray-700 border-gray-600 text-gray-100 placeholder-gray-400'
      : 'border-gray-300 text-gray-900'
  }`;
